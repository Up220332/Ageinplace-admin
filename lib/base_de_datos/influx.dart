...
class BaterryData {
  ...
  BaterryData(this.level, this.timestamp);
}

class RoomData {
  final String room;
  final DateTime timestamp;
  final int codHabitacionSensor;
...
class StepData {
  final dynamic steps;
  final DateTime timestamp;
  StepData(this.steps, this.timestamp);
}

class AlarmaData {
  final int caida;
  final int boton;
  final DateTime timestampCaida;
  final DateTime timestampBoton;
...
class AlarmaData2 {
  ...
  final dynamic value;
  final DateTime timestamp;
  AlarmaData2(this.name, this.value, this.timestamp);
}
...
class LTSMData {
  ...
  final DateTime timestamp;
  final String name;
  LTSMData(this.value, this.timestamp, this.name);
}
...
class DoorSensorData {
  ...
  final int value;
  final String codDs;
  DoorSensorData(this.timestamp, this.value, this.codDs);
}
